    ...
    <div className={styles.about}>
        ...
        <div className={styles.wrapper}>
              <div className={styles.content}>
                ...
                <p>Now, I have just finished my studies and have been a part of various interesting projects. Anything from design/homepage to a booking site. My focus lies with happy customers.</p>
